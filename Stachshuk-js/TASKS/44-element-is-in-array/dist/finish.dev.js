 ...
 */
var transports = ['Bus', 'Car', 'Bicycle', 'Airplane']; // const isElementInArray = (inputArray, searchElement) => inputArray.find((element) => element === searchElement)?true:false

var isElementInArray = function isElementInArray(inputArray, searchElement) {
