...
/*#__PURE__*/
function (_Array) {
  _inherits(ExtendedArray, _Array);

  function ExtendedArray() {
    _classCallCheck(this, ExtendedArray);

    return _possibleConstructorReturn(this, _getPrototypeOf(ExtendedArray).apply(this, arguments));
  }

  _createClass(ExtendedArray, [{
    key: "sum",
    value: function sum() {
...
var myExtendedArray = new ExtendedArray(10, 5, "число", 4);
