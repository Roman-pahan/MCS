 ...
 */
var a = [5, 'abc', 10, 1];
var b = [4, 10, 14, 25, 25, 50];
var c = [150, 132, 80, 40];
var d = [15, 26, 10, 23, 85];

var arraySortInfo = function arraySortInfo(inputArray) {
  if (inputArray.some(function (el) {
    return typeof el !== "number";
  })) {
    return "Некоторые элементы не являются числами";
  }

  if (inputArray.every(function (element, index) {
    return index > 0 ? element >= inputArray[index - 1] : true;
  })) {
