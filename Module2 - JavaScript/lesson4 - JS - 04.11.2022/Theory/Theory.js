...
let numbers2 = [9, 5, 14, 3, 11]

let numbersAboveTen2 = numbers.filter(function(number) { 
  return true
})
...
//   }
function getAboveZero(temperatures) {
    let plustemperatures = temperatures.filter(function(temperature){
...
let firstSpike = checks.find(function(check) { //Возвращает именно значение - не массив
  return check > 6.5
})
...
//Склеивание массива
let seal1 = races.join("") // "ZergProtossTerran"
let seal2 = races.join("_") // "Zerg_Protoss_Terran"
let seal3 = races.join("@@@") // "Zerg@@@Protoss@@@Terran"
console.log(seal1)
console.log(seal2)
console.log(seal3)
